...
NOISE_DISTRIBUTION = _setting("NOISE_DISTRIBUTION")
NOISE_COILS = _setting("NOISE_COILS")
...
AUG_BVEC_MASK_PROB = _setting("AUG_BVEC_MASK_PROB")
AUG_BVEC_MASK_MIN_KEEP = _setting("AUG_BVEC_MASK_MIN_KEEP")
AUG_BVEC_MASK_MAX_KEEP = _setting("AUG_BVEC_MASK_MAX_KEEP")
EVAL_BVEC_MASK_KEEP = _setting("EVAL_BVEC_MASK_KEEP")
