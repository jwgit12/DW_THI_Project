...
The attention in this module operates only across diffusion directions. It
builds one token per volume, applies self-attention over the ``N`` direction
axis, and then fuses the original spatial DWI signal with the contextualized
